 ...
 *  @param pos0         Posicao da rota0 que recebera um cliente (0 1 2 0; se pos0=0 => 0
 * * 1 2 0)
 ...
 *  *******************************************************************************************
 *  *******************************************************************************************/
bool mvInterRotasShift(SolucaoNS::Solucao &sol,
                       double              alphaBin,
                       int                 idRota0,
                       int                 pos0,
                       int                 idRota1,
 ...
 *  *******************************************************************************************
 *  *******************************************************************************************/
bool mvInterRotasSwap(SolucaoNS::Solucao &sol,
                      double              alphaBin,
                      int                 idRota0,
                      int                 pos0,
                      int                 idRota1,
 ...
 *  *******************************************************************************************
 *  *******************************************************************************************/
bool mvInterRotasCross(SolucaoNS::Solucao &sol,
                       double              alphaBin,
                       int                 idRota0,
                       int                 pos0,
                       int                 idRota1,
...
template <typename T>
bool buscaIntraRota(SolucaoNS::Solucao &solucao,
                    T Func(SolucaoNS::Solucao &sol, int rotaR, int pos0, int pos1))
{
