...
inline __attribute__((always_inline)) int getRandInt(const int ini, const int fim)
{
...
inline __attribute__((always_inline)) double getRandDouble()
{
...
// val aleatorio entre [ini; fim)
inline __attribute__((always_inline)) double getRandDouble(const double ini,
                                                           const double fim)
{
