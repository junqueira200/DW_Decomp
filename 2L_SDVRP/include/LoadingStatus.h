...
{
    None = 0, // For safety.
    Complete, // all selected loading constraints, i.e. all or subset of no overlap,
              // fragility, support, lifo
    CompleteNoSequence, // all selected loading constraints, i.e. all or subset of no
                        // overlap, fragility, support, lifo without given sequence
    ...
    NoSupportNoSequence, // all selected loading constraints, lifo without given sequence,
                         // but support definitely disabled
    LifoNoSequence,      // Only lifo without given sequence, but support and fragility
                         // definitely disabled
    NoSupportNoLifo, // all selected loading constraints, but support and lifo definitely
                     // disabled
    NoSupportNoFragility, // all selected loading constraints, but support and fragility
                          // definitely disable
