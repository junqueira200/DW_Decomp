...
int main()
{
    ...
    auto vetPairSubProb = std::vector<std::pair<int, int>>{
        std::make_pair(0, N * N), std::make_pair(N * N, N * N)};
    ...
    DW_DecompNS::DW_DecompNode decompNode(
        env, mestre, 99999.0, (DW_DecompNS::SubProb *)&subProb, 2, auxVectors, info);
