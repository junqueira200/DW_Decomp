...
void addMasterCut(const RobustCut            &cut,
...
void   writeToFile(StatisticsNS::StatisticsData &statisticsD,
                   const std::string            &fileStr,
                   std::string                  &extraHead,
                   std::string                  &extraCont);

inline __attribute__((always_inline)) bool isInteger(double val)
{
