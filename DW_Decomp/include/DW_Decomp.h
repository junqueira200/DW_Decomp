...
void            getSparseMatModel(GRBModel                                     &model,
...
template <typename T> class DelVetFunctor
{
  public:
...
inline bool operator==(const SolXHash &sol0, const SolXHash &sol1)
{
...
inline std::size_t hash_value(const SolXHash &solXHash) { return solXHash.hashVal; }
...
class DW_DecompNode
{
  public:
    ...
    Eigen::SparseMatrix<double, Eigen::RowMajor> matA;
    Vector<std::unique_ptr<Eigen::VectorXd>>
                                   vetVarLambdaCol; // Vectors generated by sub problems
