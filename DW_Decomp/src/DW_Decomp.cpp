    ...
    while(subProbCustR_neg)
    {
           ...
           itCG > 0) // && phaseStatus == PhaseStatus::PhaseStatusColGen)
        {
            ...
            /*
            {
                ...
                {
                    localStabilizationAlpha =
            RandNs::getRandDouble(StabilizationAlpha-0.1, StabilizationAlpha+0.1);
            ...
            */
            ...
            auxVect.vetRowRmlpSmoothPi =
                (1.0 - localStabilizationAlpha) * auxVect.vetRowRmlpSmoothPi +
