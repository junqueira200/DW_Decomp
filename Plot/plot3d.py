...
def draw_box(ax, x, y, z, dx, dy, dz, alpha=0.4, facecolor=None, edgecolor="black"):
...
def plot_items(items):
    ...
    for it in items:
        ...
        ax.text(it["x"], it["y"], it["z"], f"ID {it['id']}", fontsize=9)
    ...
    ax.set_box_aspect([TRUCK_WIDTH, TRUCK_LENGTH, TRUCK_HEIGHT])
