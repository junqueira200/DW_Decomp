...
void InstanceVRPTW_NS::leInstanciaSalomon(const std::string &strFile, InstanceVRPTW &instVrpTw)
{
...
void InstanceVRPTW_NS::leInstanciaAugerat(const std::string &strFile, InstanceVRPTW &instCvrp)
{
