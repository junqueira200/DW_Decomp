...
/*    vetMatResCost = LabelingAlgorithmNS::Vet3D_ResCost(2);
...
/*    for(int i=0; i < instVrpTw->numClientes+1; ++i)
    ...
    for(int i=0; i < instVrpTw->numClientes+1; ++i)
    {
        ...
        vetVetResBound.get(i, 1) = bound1;
    }

    for(int i=0; i < instVrpTw->numClientes+1; ++i)
        std::cout<<vetVetResBound(i, 1)<<"\n";
