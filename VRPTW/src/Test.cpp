...
void TestNS::combinationUtil(int              ind,
                             int              r,
                             VectorI         &data,
...
void TestNS::enumerateRoutes(InstanceVRPTW_NS::InstanceVRPTW &instVrp,
                             int                              numMax,
                             RouteHash                       &routeHash)
{
    VectorI         vet;
...
FloatType TestNS::computeReducedCost(const Route              &route,
