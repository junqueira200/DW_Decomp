...
void convertLabelBackwardToForward(Label                *label,
...
void updateLabelCost(Label               &label,
...
bool containRoute(const Eigen::Array<Label *, 1, DW_DecompNS::NumMaxSolSubProb> &vetLabel,
                  int                                                            numSol,
                  Label                                                         *label);
